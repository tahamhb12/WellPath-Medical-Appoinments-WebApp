...
import Patient_dash_interface from "./patient_dashboard_interface";
import Alldoctors_interface from "./patient_alldoctors_inerface";
import useAuthContext from "../../context/AuthContext";
import My_Appointments from "./patient_My_Appointments_interface";
import Settings from "./settings";

const Patient_dashboard = () => {

    const {header,appointments,getDemands,getAppoinments,demands} = useAuthContext()
...
{/*                     <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="notification">
                    <input type="text" placeholder="Search" onChange={(e)=>settabs(e.target.value)}/>
                    <svg onClick={()=>setshow(!show)} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Dashboard_navbars tabs={tabs} settabs={settabs}
                ...
                name5={"Settings"}
            />
            {tabs =="Dashboard" && <Patient_dash_interface settabs={settabs} setstatus={setstatus}/>}
            {tabs =="Doctors List" &&<Alldoctors_interface/>}
            {tabs =="Appointments" &&<My_Appointments status={status} setstatus={setstatus}/>}
