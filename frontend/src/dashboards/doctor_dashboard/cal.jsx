...
const Calendar = (props) => {
    ...
    const day_appointments = appointments.filter((x) => x.date === formattedSelectedDate && x.doctor_id === user.id)
    ...
    return (
        <div className="calendar">
            ...
            <div className="todays_apps_interface">
                {appointments.filter((x) => x.date === formattedSelectedDate && x.doctor_id === user.id)
                .sort((a, b) => {
